...
func (x *UsersListResponse) GetMeta() *Meta {
	if x != nil {
		return x.Meta
	}
	return nil
...
const file_proto_user_proto_rawDesc = "" +
	...
	"\vGetAllUsers\x12\x17.user.GetAllUserRequest\x1a\x17.user.UsersListResponse\x121\n" +
	"\n" +
...
var file_proto_user_proto_goTypes = []any{
	...
	(*GetAllUserRequest)(nil),  // 10: user.GetAllUserRequest
	(*Meta)(nil),               // 11: user.Meta
...
var file_proto_user_proto_depIdxs = []int32{
	...
	2,  // 2: user.ListUsersResponse.users:type_name -> user.User
	2,  // 3: user.UsersListResponse.users:type_name -> user.User
	11, // 4: user.UsersListResponse.meta:type_name -> user.Meta
	0,  // 5: user.UserService.Login:input_type -> user.LoginRequest
	4,  // 6: user.UserService.GetUserById:input_type -> user.GetUserRequest
	10, // 7: user.UserService.GetAllUsers:input_type -> user.GetAllUserRequest
	...
	3,  // 12: user.UserService.GetUserById:output_type -> user.GetUserResponse
	12, // 13: user.UserService.GetAllUsers:output_type -> user.UsersListResponse
	2,  // 14: user.UserService.UpdateUser:output_type -> user.User
	7,  // 15: user.UserService.DeleteUser:output_type -> user.DeleteUserResponse
	9,  // 16: user.UserService.ListUsers:output_type -> user.ListUsersResponse
